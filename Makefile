...
noinst_PROGRAMS = $(am__EXEEXT_1) tests/test-controller$(EXEEXT) \
	tests/test-ovsdb$(EXEEXT) $(am__EXEEXT_2) \
	tests/ovstest$(EXEEXT) tests/test-strtok_r$(EXEEXT) \
...
DIST_COMMON = $(srcdir)/manpages.mk $(srcdir)/m4/automake.mk \
	...
	$(srcdir)/datapath-windows/automake.mk $(srcdir)/Makefile.in \
...
am__append_17 = lib/async-append-aio.c
#am__append_18 = lib/async-append-null.c
#am__append_19 = \
#        lib/route-table-stub.c
...
am__append_21 = lib/stream-ssl.c
am__append_22 = lib/dhparams.c
#am__append_23 = lib/stream-nossl.c
#am__append_24 = ${PTHREAD_LIBS}
#am__append_25 = \
...
am__append_26 = utilities/ovs-vlan-bug-workaround
am__append_27 = utilities/nlmon
#am__append_28 = utilities/bugtool/ovs-bugtool
#am__append_29 = utilities/bugtool/ovs-bugtool
#am__append_30 = utilities/bugtool/ovs-bugtool.8
#am__append_31 = utilities/bugtool/ovs-bugtool.8.in
#am__append_32 = utilities/bugtool/ovs-bugtool.8
#am__append_33 = $(bugtool_scripts)
#am__append_34 = bugtool-install-data-local
#am__append_35 = bugtool-uninstall-local
#am__append_36 = tests/ovsclient
am__append_37 = \
	tests/test-unix-socket.c

am__append_38 = $(TESTPKI_FILES)
am__append_39 = $(TESTPKI_FILES) tests/ovs-pki.log
am__append_40 = clean-pki
#am__append_41 = .h .hstamp
#am__append_42 = $(HSTAMP_FILES)
#am__append_43 = $(HSTAMP_FILES)
##am__append_44 = vswitchd/vswitch.gv vswitchd/vswitch.pic
##am__append_45 = vtep/vtep.gv vtep/vtep.pic
subdir = .
...
am__lib_libopenvswitch_la_SOURCES_DIST = lib/aes128.c lib/aes128.h \
	...
	lib/classifier.c lib/classifier.h lib/cmap.c lib/cmap.h \
	...
	lib/daemon.c lib/daemon.h lib/daemon-private.h lib/dhcp.h \
	lib/dummy.c lib/dummy.h lib/dhparams.h lib/dirs.h lib/dpctl.c \
	lib/dpctl.h lib/dpif-netdev.c lib/dpif-netdev.h \
	...
	lib/match.c lib/match.h lib/mcast-snooping.c \
	lib/mcast-snooping.h lib/memory.c lib/memory.h lib/meta-flow.c \
	lib/meta-flow.h lib/multipath.c lib/multipath.h \
	lib/netdev-dummy.c lib/netdev-provider.h lib/netdev-vport.c \
	lib/netdev-vport.h lib/netdev.c lib/netdev.h lib/netflow.h \
	lib/netlink.c lib/netlink.h lib/nx-match.c lib/nx-match.h \
	...
	lib/ofpbuf.h lib/ovs-atomic-c11.h lib/ovs-atomic-clang.h \
	...
	lib/packet-dpif.c lib/packet-dpif.h lib/packets.c \
	lib/packets.h lib/pcap-file.c lib/pcap-file.h lib/poll-loop.c \
	lib/poll-loop.h lib/process.c lib/process.h lib/pvector.c \
	lib/pvector.h lib/random.c lib/random.h lib/rconn.c \
	lib/rconn.h lib/reconnect.c lib/reconnect.h lib/sat-math.h \
	lib/seq.c lib/seq.h lib/sha1.c lib/sha1.h lib/shash.c \
	lib/shash.h lib/simap.c lib/simap.h lib/smap.c lib/smap.h \
	...
	lib/socket-util-unix.c lib/stream-fd-unix.c lib/stream-unix.c \
...
am__objects_2 = lib/daemon-unix.lo lib/latch-unix.lo \
	...
	lib/stream-fd-unix.lo lib/stream-unix.lo
...
#am__objects_5 = lib/netlink-notifier.lo \
...
#am__objects_9 = lib/netdev-bsd.lo lib/rtbsd.lo \
...
am_lib_libopenvswitch_la_OBJECTS = lib/aes128.lo lib/backtrace.lo \
	...
	lib/daemon.lo lib/dummy.lo lib/dpctl.lo lib/dpif-netdev.lo \
	...
	lib/hmapx.lo lib/jhash.lo lib/json.lo lib/jsonrpc.lo \
	lib/lacp.lo lib/learn.lo lib/learning-switch.lo lib/list.lo \
	...
	lib/ofpbuf.lo lib/ovs-atomic-locked.lo lib/ovs-rcu.lo \
	lib/ovs-thread.lo lib/ovsdb-data.lo lib/ovsdb-error.lo \
	lib/ovsdb-idl.lo lib/ovsdb-parser.lo lib/ovsdb-types.lo \
	lib/packet-dpif.lo lib/packets.lo lib/pcap-file.lo \
	lib/poll-loop.lo lib/process.lo lib/pvector.lo lib/random.lo \
	lib/rconn.lo lib/reconnect.lo lib/seq.lo lib/sha1.lo \
	lib/shash.lo lib/simap.lo lib/smap.lo lib/socket-util.lo \
	lib/sort.lo lib/sset.lo lib/stp.lo lib/stream-tcp.lo \
...
#am__EXEEXT_2 = tests/ovsclient$(EXEEXT)
...
ovsdb_ovsdb_tool_DEPENDENCIES = ovsdb/libovsdb.la \
	lib/libopenvswitch.la
am__tests_ovsclient_SOURCES_DIST = tests/ovs_client/ovs_client.c
#am_tests_ovsclient_OBJECTS =  \
#	tests/ovs_client/ovs_client.$(OBJEXT)
tests_ovsclient_OBJECTS = $(am_tests_ovsclient_OBJECTS)
#tests_ovsclient_DEPENDENCIES =  \
...
am_tests_ovstest_OBJECTS = tests/ovstest.$(OBJEXT) \
	...
	tests/test-vconn.$(OBJEXT) $(am__objects_13)
...
SOURCES = $(lib_libopenvswitch_la_SOURCES) \
	...
	$(tests_ovsclient_SOURCES) $(tests_ovstest_SOURCES) \
...
DIST_SOURCES = $(am__lib_libopenvswitch_la_SOURCES_DIST) \
	...
	$(ovsdb_libovsdb_la_SOURCES) $(ovsdb_ovsdb_client_SOURCES) \
	$(ovsdb_ovsdb_server_SOURCES) $(ovsdb_ovsdb_tool_SOURCES) \
	$(am__tests_ovsclient_SOURCES_DIST) \
...
DATA = $(dist_pkgdata_DATA) $(dist_scripts_DATA) \
	...
	$(scripts_DATA)
am__noinst_HEADERS_DIST = CONTRIBUTING CodingStyle DESIGN FAQ INSTALL \
	INSTALL.Debian INSTALL.DPDK INSTALL.Fedora INSTALL.KVM \
	INSTALL.Libvirt INSTALL.NetBSD INSTALL.RHEL INSTALL.SSL \
	INSTALL.XenServer INSTALL.userspace INSTALL.Windows \
	...
	lib/daemon-syn.man lib/dpctl.man lib/memory-unixctl.man \
	...
	tests/dpif-netdev.at tests/ofproto-dpif.at tests/bridge.at \
	...
	python/ovs/__init__.py python/ovs/daemon.py python/ovs/appctl.py \
...
ACLOCAL = ${SHELL} /home/corentih/ovs/build-aux/missing aclocal-1.14
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AUTOCONF = ${SHELL} /home/corentih/ovs/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/corentih/ovs/build-aux/missing autoheader
AUTOM4TE = ${SHELL} /home/corentih/ovs/build-aux/missing autom4te
AUTOMAKE = ${SHELL} /home/corentih/ovs/build-aux/missing automake-1.14
AWK = gawk
...
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/corentih/ovs/build-aux/missing makeinfo
MANIFEST_TOOL = :
...
PTHREAD_LDFLAGS = 
PTHREAD_LIBS = 
PYTHON = ${SHELL} /home/corentih/ovs/build-aux/missing python
RANLIB = ranlib
...
STRIP = strip
VERSION = 2.3.90
WARNING_FLAGS =  -Wall -Wextra -Wno-sign-compare -Wpointer-arith -Wno-format-zero-length -Wswitch-enum -Wunused-parameter -Wstrict-aliasing -Wbad-function-cast -Wcast-align -Wmissing-prototypes -Wmissing-field-initializers
abs_builddir = /home/corentih/ovs
abs_srcdir = /home/corentih/ovs
abs_top_builddir = /home/corentih/ovs
abs_top_srcdir = /home/corentih/ovs
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /home/corentih/ovs/build-aux/install-sh
...
pdfdir = ${docdir}
prefix = /home/corentih/ovs/custom
...
AM_CPPFLAGS = $(SSL_CFLAGS) $(am__append_1) -I $(top_srcdir)/include \
	...
	$(top_builddir)/lib $(SSL_INCLUDES) $(am__append_3)
...
ALL_LOCAL = $(am__append_5) config-h-check printf-check static-check \
	...
	$(am__append_43) check-debian-changelog-version \
...
CLEANFILES = $(am__append_6) $(am__append_8) manpage-dep-check \
	$(nodist_lib_libopenvswitch_la_SOURCES) \
	ofproto/ipfix-entities.def $(am__append_29) \
	$(valgrind_wrappers) $(am__append_39) include/odp-netlink.h \
	$(am__append_42) vswitchd/vswitch.ovsschema.stamp \
	vswitchd/vswitch-idl.c vswitchd/vswitch-idl.h \
	vtep/vtep.ovsschema.stamp
CLEAN_LOCAL = clean-pycov $(am__append_40)
...
EXTRA_DIST = CONTRIBUTING CodingStyle DESIGN FAQ INSTALL \
	INSTALL.Debian INSTALL.DPDK INSTALL.Fedora INSTALL.KVM \
	INSTALL.Libvirt INSTALL.NetBSD INSTALL.RHEL INSTALL.SSL \
	INSTALL.XenServer INSTALL.userspace INSTALL.Windows \
	IntegrationGuide NOTICE OPENFLOW-1.1+ PORTING README-lisp \
	...
	$(MAN_ROOTS) build-aux/thread-safety-blacklist \
	...
	$(srcdir)/lib/vtep-idl.ann build-aux/extract-ofp-errors \
	...
	datapath-windows/CodingStyle datapath-windows/DESIGN \
	datapath-windows/Package/package.VcxProj \
	datapath-windows/Package/package.VcxProj.user \
	datapath-windows/include/OvsNetlink.h \
	datapath-windows/include/OvsPub.h \
	...
	datapath-windows/ovsext/precomp.h \
	datapath-windows/ovsext/precompsrc.c
bin_SCRIPTS = utilities/ovs-pki $(am__append_25)
...
dist_scripts_DATA = 
INSTALL_DATA_LOCAL = lib-install-data-local $(am__append_34)
UNINSTALL_LOCAL = $(am__append_35) ovs-uninstall-local
# ovsdb-tool.1
# ovsdb-client.1
# ovsdb-server.1
man_MANS = utilities/ovs-appctl.8 utilities/ovs-benchmark.1 \
	...
	utilities/ovs-vsctl.8 $(am__append_30) vswitchd/ovs-vswitchd.8 \
	vswitchd/ovs-vswitchd.conf.db.5 ovsdb/ovsdb-tool.1 \
...
MAN_ROOTS = utilities/ovs-appctl.8.in utilities/ovs-benchmark.1.in \
	...
	utilities/ovs-vlan-bug-workaround.8.in utilities/ovs-test.8.in \
	utilities/ovs-vlan-test.8.in utilities/ovs-vsctl.8.in \
	$(am__append_31) tests/test-controller.8.in \
	vswitchd/ovs-vswitchd.8.in ovsdb/ovsdb-tool.1.in \
	ovsdb/ovsdb-client.1.in ovsdb/ovsdb-server.1.in \
	ovsdb/ovsdb-idlc.1 vtep/vtep-ctl.8.in
noinst_DATA = 
...
noinst_HEADERS = $(EXTRA_DIST) include/openflow/nicira-ext.h \
...
sbin_SCRIPTS = $(am__append_28)

# ovs-vtep
scripts_SCRIPTS = utilities/ovs-check-dead-ifs utilities/ovs-ctl \
	utilities/ovs-save $(am__append_33) vtep/ovs-vtep
scripts_DATA = utilities/ovs-lib
SUFFIXES = .in $(am__append_41) .ovsidl .ovsschema
...
nodist_lib_libopenvswitch_la_SOURCES = lib/dirs.c $(am__append_22)
...
ofproto_libofproto_la_LIBADD = lib/libsflow.la $(am__append_24)
...
am--refresh: Makefile
	@:
$(srcdir)/Makefile.in:  $(srcdir)/Makefile.am $(srcdir)/manpages.mk $(srcdir)/m4/automake.mk $(srcdir)/lib/automake.mk $(srcdir)/ofproto/automake.mk $(srcdir)/utilities/automake.mk $(srcdir)/utilities/bugtool/automake.mk $(srcdir)/tests/automake.mk $(srcdir)/include/automake.mk $(srcdir)/include/openflow/automake.mk $(srcdir)/include/openvswitch/automake.mk $(srcdir)/include/sparse/automake.mk $(srcdir)/include/windows/automake.mk $(srcdir)/third-party/automake.mk $(srcdir)/debian/automake.mk $(srcdir)/vswitchd/automake.mk $(srcdir)/ovsdb/automake.mk $(srcdir)/rhel/automake.mk $(srcdir)/xenserver/automake.mk $(srcdir)/python/automake.mk $(srcdir)/python/compat/automake.mk $(srcdir)/tutorial/automake.mk $(srcdir)/vtep/automake.mk $(srcdir)/datapath-windows/automake.mk $(am__configure_deps)
	@for dep in $?; do \
...
$(srcdir)/manpages.mk $(srcdir)/m4/automake.mk $(srcdir)/lib/automake.mk $(srcdir)/ofproto/automake.mk $(srcdir)/utilities/automake.mk $(srcdir)/utilities/bugtool/automake.mk $(srcdir)/tests/automake.mk $(srcdir)/include/automake.mk $(srcdir)/include/openflow/automake.mk $(srcdir)/include/openvswitch/automake.mk $(srcdir)/include/sparse/automake.mk $(srcdir)/include/windows/automake.mk $(srcdir)/third-party/automake.mk $(srcdir)/debian/automake.mk $(srcdir)/vswitchd/automake.mk $(srcdir)/ovsdb/automake.mk $(srcdir)/rhel/automake.mk $(srcdir)/xenserver/automake.mk $(srcdir)/python/automake.mk $(srcdir)/python/compat/automake.mk $(srcdir)/tutorial/automake.mk $(srcdir)/vtep/automake.mk $(srcdir)/datapath-windows/automake.mk:
...
lib/packet-dpif.lo: lib/$(am__dirstamp) lib/$(DEPDIR)/$(am__dirstamp)
...
tests/ovs_client/$(am__dirstamp):
	@$(MKDIR_P) tests/ovs_client
	@: > tests/ovs_client/$(am__dirstamp)
tests/ovs_client/$(DEPDIR)/$(am__dirstamp):
	@$(MKDIR_P) tests/ovs_client/$(DEPDIR)
	@: > tests/ovs_client/$(DEPDIR)/$(am__dirstamp)
tests/ovs_client/ovs_client.$(OBJEXT):  \
	tests/ovs_client/$(am__dirstamp) \
	tests/ovs_client/$(DEPDIR)/$(am__dirstamp)
...
tests/ovsclient$(EXEEXT): $(tests_ovsclient_OBJECTS) $(tests_ovsclient_DEPENDENCIES) $(EXTRA_tests_ovsclient_DEPENDENCIES) tests/$(am__dirstamp)
	@rm -f tests/ovsclient$(EXEEXT)
	$(AM_V_CCLD)$(LINK) $(tests_ovsclient_OBJECTS) $(tests_ovsclient_LDADD) $(LIBS)
...
include lib/$(DEPDIR)/packet-dpif.Plo
...
include tests/ovs_client/$(DEPDIR)/ovs_client.Po
...
distclean-generic:
	...
	-rm -f tests/ovs_client/$(DEPDIR)/$(am__dirstamp)
	-rm -f tests/ovs_client/$(am__dirstamp)
...
distclean: distclean-recursive
	...
	-rm -rf lib/$(DEPDIR) ofproto/$(DEPDIR) ovsdb/$(DEPDIR) tests/$(DEPDIR) tests/ovs_client/$(DEPDIR) utilities/$(DEPDIR) vswitchd/$(DEPDIR) vtep/$(DEPDIR)
	-rm -f Makefile
